...
def _is(header):
    ...
    words_combinations_list = ['location', 'adresse', 'adresse postale', 'adresse geographique', 'adr', 'adresse complete', 'adresse station', 'street', 'address', 'postal address', 'geographical address', 'complete address']
